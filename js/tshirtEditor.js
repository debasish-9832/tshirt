	   ...
	   $('#flip').click(
		   function() {			   
			   	if ($(this).attr("data-original-title") == "Show Back View") {
					...
					document.getElementById("buttonAppear").innerHTML = "<input  type='button' onClick='back()' class='bt_style' style='margin-top:23px;' value='Save Back Image' />	";
					$("#hidden_data").attr('id', 'hidden_data_back');
					  $("#cap").hide();
					...
					$("#hidden_data_back").attr('id', 'hidden_data');
					  $("#cap").show();
